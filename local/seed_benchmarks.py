...
# batch2 2026-05-06
BENCHMARKS += [
    b("finisher_pig","fcr_finisher_pig_cn_all",2.6,"kg_feed_per_kg_gain",value_min=2.4,value_max=2.8,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="全國生豬遺傳改良計劃技術規範 NY/T 2894-2016",note="90-120kg出欄，商業規模料肉比"),
    b("finisher_pig","adg_finisher_pig_cn_all",800,"g_per_day",value_min=700,value_max=900,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="農業農村部生豬生產形勢監測 2023",note="60-120kg育肥階段平均日增重"),
    b("finisher_pig","mortality_finisher_pig_cn_all",3.0,"percentage",value_min=2.0,value_max=5.0,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="中國養豬行業調研報告 2023",note="育肥期死淘率"),
    b("finisher_pig","slaughter_weight_finisher_pig_cn_all",115,"kg",value_min=105,value_max=125,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="農業農村部生豬屠宰統計 2023",note="出欄體重"),
    b("finisher_pig","prrs_fcr_penalty_finisher_pig_cn_all",20,"percentage_points",value_min=10,value_max=30,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="PRRS對豬生產性能影響田間調查 2022",note="藍耳病感染場FCR惡化幅度%"),
    b("finisher_pig","asf_restocking_mortality_cn_all",50,"percentage",value_min=30,value_max=80,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="農業農村部非洲豬瘟防控報告 2022-2024",note="ASF急性爆發死亡率；復養後前3個月死淘率較高"),
    b("nursery_pig","fcr_nursery_pig_cn_all",1.65,"kg_feed_per_kg_gain",value_min=1.5,value_max=1.8,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="保育豬飼養管理技術規範 2022",note="7-30kg保育階段料肉比"),
    b("nursery_pig","adg_nursery_pig_cn_all",420,"g_per_day",value_min=350,value_max=500,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="保育豬飼養管理技術規範 2022",note="保育階段平均日增重"),
    b("nursery_pig","mortality_nursery_pig_cn_all",5.0,"percentage",value_min=3.0,value_max=8.0,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="中國養豬行業調研報告 2023",note="保育期死淘率"),
    b("nursery_pig","ped_mortality_nursery_pig_cn_all",40,"percentage",value_min=20,value_max=80,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="豬流行性腹瀉PED流行病學調查 2022-2024",note="PED急性爆發；7日齡以下仔豬死亡率可達100%"),
    b("nursery_pig","prrs_adg_penalty_nursery_pig_cn_all",25,"percentage_points",value_min=15,value_max=35,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="PRRS對保育豬生長影響研究 2021",note="藍耳病感染後保育豬ADG下降幅度%"),
    b("lactating_sow","litter_size_lactating_sow_cn_all",11.5,"piglets_per_litter",value_min=10.0,value_max=13.0,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="全國生豬遺傳改良計劃年度報告 2023",note="窩均活仔數"),
    b("lactating_sow","piglet_survival_lactating_sow_cn_all",88.0,"percentage",value_min=85.0,value_max=92.0,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="規模豬場哺乳仔豬管理調研 2022",note="出生至斷奶存活率"),
    b("lactating_sow","weaning_weight_lactating_sow_cn_all",7.0,"kg",value_min=6.0,value_max=8.5,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="規模豬場哺乳仔豬管理調研 2022",note="21-28天斷奶體重"),
    b("lactating_sow","prrs_piglet_mortality_lactating_sow_cn_all",25,"percentage_points",value_min=15,value_max=40,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="PRRS對繁殖母豬影響田間調查 2022",note="PRRS感染場哺乳仔豬死亡率上升"),
    b("lactating_sow","ped_litter_mortality_lactating_sow_cn_all",60,"percentage",value_min=30,value_max=90,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="PED流行病學調查 2022-2024",note="新生仔豬PED死亡率"),
    b("beef_cattle","adg_beef_cattle_cn_all",1.1,"kg_per_day",value_min=0.9,value_max=1.3,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="肉牛飼養標準 NY/T 815-2021",note="育肥期平均日增重"),
    b("beef_cattle","fcr_beef_cattle_cn_all",7.0,"kg_feed_per_kg_gain",value_min=6.0,value_max=8.5,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="肉牛飼養標準 NY/T 815-2021",note="育肥期料肉比"),
    b("beef_cattle","mortality_beef_cattle_cn_all",2.0,"percentage",value_min=1.0,value_max=3.5,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="農業農村部肉牛生產監測 2023",note="育肥期死亡率"),
    b("beef_cattle","brd_mortality_beef_cattle_cn_all",15,"percentage",value_min=5,value_max=30,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="牛呼吸道疾病BRD流行病學調查 2022",note="牛呼吸道病綜合症死亡率"),
    b("beef_cattle","brd_adg_penalty_beef_cattle_cn_all",18,"percentage_points",value_min=10,value_max=25,region="CN_all",year=2023,credibility=3,source_type="academic_background",source_title="BRD對肉牛生長影響研究 2021",note="BRD感染後ADG下降幅度%"),
    b("meat_sheep","adg_meat_sheep_cn_all",250,"g_per_day",value_min=200,value_max=320,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="肉羊飼養標準 NY/T 816-2021",note="集約化育肥日增重"),
    b("meat_sheep","fcr_meat_sheep_cn_all",5.5,"kg_feed_per_kg_gain",value_min=4.5,value_max=7.0,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="肉羊飼養標準 NY/T 816-2021",note="育肥期料肉比"),
    b("meat_sheep","mortality_meat_sheep_cn_all",5.0,"percentage",value_min=3.0,value_max=8.0,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="農業農村部肉羊生產監測 2023",note="全期死淘率"),
    b("meat_sheep","ppr_mortality_meat_sheep_cn_all",40,"percentage",value_min=20,value_max=70,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="小反芻獸疫PPR流行病學調查 OIE 2023",note="小反芻獸疫爆發未免疫群死亡率"),
    b("meat_goat","adg_meat_goat_cn_all",185,"g_per_day",value_min=150,value_max=220,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="肉山羊飼養技術規範 DB/T 2022",note="集約化育肥日增重"),
    b("meat_goat","fcr_meat_goat_cn_all",6.5,"kg_feed_per_kg_gain",value_min=5.5,value_max=8.0,region="CN_all",year=2023,credibility=3,source_type="academic_background",source_title="肉山羊飼養技術規範 DB/T 2022",note="育肥期料肉比"),
    b("meat_goat","mortality_meat_goat_cn_all",5.5,"percentage",value_min=4.0,value_max=7.5,region="CN_all",year=2023,credibility=3,source_type="academic_background",source_title="農業農村部山羊養殖調研 2022",note="全期死淘率"),
    b("meat_goat","ppr_mortality_meat_goat_cn_all",30,"percentage",value_min=15,value_max=50,region="CN_all",year=2023,credibility=4,source_type="academic_background",source_title="小反芻獸疫PPR流行病學調查 OIE 2023",note="山羊PPR死亡率略低於綿羊"),
    b("tilapia","fcr_tilapia_cn_south",1.45,"kg_feed_per_kg_gain",value_min=1.3,value_max=1.6,region="CN_south",year=2023,credibility=4,source_type="academic_background",source_title="羅非魚養殖技術規範 DB44-2021",note="池塘養殖FCR"),
    b("tilapia","adg_tilapia_cn_south",3.2,"g_per_day",value_min=2.5,value_max=4.0,region="CN_south",year=2023,credibility=4,source_type="academic_background",source_title="羅非魚養殖技術規範 DB44-2021",note="日增重"),
    b("tilapia","survival_tilapia_cn_south",80,"percentage",value_min=75,value_max=88,region="CN_south",year=2023,credibility=4,source_type="academic_background",source_title="廣東省羅非魚養殖調研 2023",note="養殖成活率"),
    b("tilapia","streptococcus_mortality_tilapia_cn_south",30,"percentage",value_min=15,value_max=50,region="CN_south",year=2023,credibility=4,source_type="academic_background",source_title="羅非魚鏈球菌病流行調查 2022-2024",note="夏季高溫鏈球菌爆發死亡率；水溫>28℃高發"),
    b("largemouth_bass","fcr_largemouth_bass_cn_south",1.25,"kg_feed_per_kg_gain",value_min=1.0,value_max=1.5,region="CN_south",year=2023,credibility=4,source_type="academic_background",source_title="加州鱸池塘養殖技術規程 DB44-2022",note="商業養殖FCR"),
    b("largemouth_bass","adg_largemouth_bass_cn_south",4.5,"g_per_day",value_min=3.0,value_max=6.0,region="CN_south",year=2023,credibility=4,source_type="academic_background",source_title="加州鱸池塘養殖技術規程 DB44-2022",note="日增重"),
    b("largemouth_bass","survival_largemouth_bass_cn_south",76,"percentage",value_min=70,value_max=83,region="CN_south",year=2023,credibility=4,source_type="academic_background",source_title="廣東省加州鱸養殖調研 2023",note="養殖成活率"),
    b("largemouth_bass","edwardsiella_mortality_largemouth_bass_cn_south",28,"percentage",value_min=15,value_max=45,region="CN_south",year=2023,credibility=3,source_type="academic_background",source_title="加州鱸愛德華氏菌病流行調查 2023",note="愛德華氏菌病爆發死亡率"),
    b("grouper","fcr_grouper_cn_south",1.65,"kg_feed_per_kg_gain",value_min=1.4,value_max=1.9,region="CN_south",year=2023,credibility=4,source_type="academic_background",source_title="石斑魚養殖技術規範 DB46-2021",note="網箱/池塘養殖FCR"),
    b("grouper","adg_grouper_cn_south",7.5,"g_per_day",value_min=5.0,value_max=10.0,region="CN_south",year=2023,credibility=4,source_type="academic_background",source_title="石斑魚養殖技術規範 DB46-2021",note="300-500g商品魚日增重"),
    b("grouper","survival_grouper_cn_south",70,"percentage",value_min=62,value_max=78,region="CN_south",year=2023,credibility=4,source_type="academic_background",source_title="海南省石斑魚養殖調研 2023",note="養殖成活率"),
    b("grouper","vibrio_mortality_grouper_cn_south",35,"percentage",value_min=20,value_max=55,region="CN_south",year=2023,credibility=4,source_type="academic_background",source_title="石斑魚弧菌病流行調查 2022-2024",note="夏季弧菌病爆發；石斑魚最常見致死疾病"),
]
